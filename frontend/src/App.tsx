...
import CalculationsIcon from '@mui/icons-material/Calculate';
import OperationsIcon from '@mui/icons-material/Functions';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a32199203">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          name="Calculations"
          options={{ label: 'Calculations' }}
          list={CalculationsList}
          create={CalculationsCreate}
          edit={CalculationsEdit}
          recordRepresentation="operationPerformed"
        ...
        <Resource
          ...
          edit={OperationsEdit}
          recordRepresentation="operationName"
          icon={OperationsIcon}
        />
